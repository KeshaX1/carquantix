...
const HOME_TRANSLATIONS = {
  en: {
    homeHeroKicker: 'Smarter vehicle decisions',
    ...
    homeTopicBuyerTitle: 'Buyer Shortlists',
    homeTopicBuyerText: 'Model comparisons, value picks and practical checks before you commit to a car.',
    homeTopicBuyerLink: 'Open guides',
    homeTopicMarketTitle: 'Market Updates',
    homeTopicMarketText: 'New vehicle launches, price moves and industry changes that can affect your next decision.',
    homeTopicMarketLink: 'Read news',
    homeTopicOwnershipTitle: 'Ownership Costs',
    homeTopicOwnershipText: 'Fuel, charging, depreciation and running-cost thinking for daily drivers and performance cars.',
    homeTopicOwnershipLink: 'View articles',
    homeTopicPerformanceTitle: 'Performance Data',
    homeTopicPerformanceText: 'Horsepower, acceleration and top-speed numbers arranged for side-by-side comparison.',
    homeTopicPerformanceLink: 'Compare cars',
    homeTopicMethodologyTitle: 'Data Methodology',
    homeTopicMethodologyText: 'How CarQuantix treats specs, estimates and model-year differences across vehicle data.',
    homeTopicMethodologyLink: 'See notes',
    homeTopicMarketplaceTitle: 'Marketplace Listings',
    homeTopicMarketplaceText: 'Browse public offers or publish a structured listing with price, mileage and seller details.',
    homeTopicMarketplaceLink: 'Visit marketplace',
    homeArticlesTitle: 'Latest CarQuantix reads',
    homeArticlesLead: 'Fresh analysis for people comparing performance, cost and ownership trade-offs before they choose.',
    homeArticlesAll: 'View all articles',
    homeArticleEvTopic: 'Electric ownership',
    homeArticleEvTitle: 'EV running costs: what to compare before the monthly bill arrives',
    homeArticleEvText: 'Look beyond range figures and compare charging price, efficiency, commute distance and seasonal losses.',
    homeArticleEvRead: '8 min read',
    homeArticlePerformanceTopic: 'Performance data',
    homeArticlePerformanceTitle: 'Horsepower, acceleration and why the numbers do not always agree',
    homeArticlePerformanceText: 'How gearing, traction and weight can change what a spec sheet seems to promise.',
    homeArticlePerformanceRead: '6 min read',
    homeArticleBuyingTopic: 'Buying guide',
    homeArticleBuyingTitle: 'The quick ownership checklist before you shortlist a used car',
    homeArticleBuyingText: 'Price is only one signal. Add mileage, fuel, depreciation and seller clarity before deciding.',
    homeArticleBuyingRead: '7 min read',
    homeArticleDate: 'Jul 3, 2026',
  },
  tr: {
    homeHeroKicker: 'Daha akilli arac kararlari',
    ...
    homeTopicBuyerTitle: 'Alici Kisa Listeleri',
    homeTopicBuyerText: 'Bir araca karar vermeden once model karsilastirmalari, deger secimleri ve pratik kontroller.',
    homeTopicBuyerLink: 'Rehberleri ac',
    homeTopicMarketTitle: 'Pazar Guncellemeleri',
    homeTopicMarketText: 'Yeni model lansmanlari, fiyat hareketleri ve siradaki kararini etkileyebilecek sektor degisimleri.',
    homeTopicMarketLink: 'Haberleri oku',
    homeTopicOwnershipTitle: 'Sahiplik Maliyetleri',
    homeTopicOwnershipText: 'Gunluk suruculer ve performans arabalari icin yakit, sarj, deger kaybi ve kullanim maliyeti dusuncesi.',
    homeTopicOwnershipLink: 'Makaleleri gor',
    homeTopicPerformanceTitle: 'Performans Verileri',
    homeTopicPerformanceText: 'Beygir gucu, hizlanma ve azami hiz rakamlari yan yana karsilastirma icin duzenlenir.',
    homeTopicPerformanceLink: 'Arabalari karsilastir',
    homeTopicMethodologyTitle: 'Veri Metodolojisi',
    homeTopicMethodologyText: 'CarQuantix teknik verileri, tahminleri ve model yili farklarini arac verilerinde nasil ele alir.',
    homeTopicMethodologyLink: 'Notlari gor',
    homeTopicMarketplaceTitle: 'Pazar Ilanlari',
    homeTopicMarketplaceText: 'Herkese acik teklifleri inceleyin veya fiyat, kilometre ve satici bilgileriyle duzenli bir ilan yayinlayin.',
    homeTopicMarketplaceLink: 'Pazaryerine git',
    homeArticlesTitle: 'En yeni CarQuantix yazilari',
    homeArticlesLead: 'Secim yapmadan once performans, maliyet ve sahiplik dengelerini karsilastiranlar icin yeni analizler.',
    homeArticlesAll: 'Tum yazilari gor',
    homeArticleEvTopic: 'Elektrikli sahiplik',
    homeArticleEvTitle: 'EV kullanim maliyetleri: aylik fatura gelmeden once neyi karsilastirmali',
    homeArticleEvText: 'Menzil rakamlarinin otesine bakin; sarj fiyatini, verimliligi, gunluk mesafeyi ve mevsimsel kayiplari karsilastirin.',
    homeArticleEvRead: '8 dk okuma',
    homeArticlePerformanceTopic: 'Performans verisi',
    homeArticlePerformanceTitle: 'Beygir gucu, hizlanma ve rakamlarin neden her zaman uyusmadigi',
    homeArticlePerformanceText: 'Vites oranlari, cekis ve agirlik bir teknik tablonun vaat ettigini nasil degistirebilir.',
    homeArticlePerformanceRead: '6 dk okuma',
    homeArticleBuyingTopic: 'Satin alma rehberi',
    homeArticleBuyingTitle: 'Ikinci el arabayi listeye almadan once hizli sahiplik kontrol listesi',
    homeArticleBuyingText: 'Fiyat sadece bir sinyaldir. Karar vermeden once kilometre, yakit, deger kaybi ve satici netligini ekleyin.',
    homeArticleBuyingRead: '7 dk okuma',
  },
  de: {
    homeHeroKicker: 'Kluigere Fahrzeugentscheidungen',
    ...
    homeTopicBuyerTitle: 'Kaufer-Shortlists',
    homeTopicBuyerText: 'Modellvergleiche, Werttipps und praktische Checks, bevor du dich festlegst.',
    homeTopicBuyerLink: 'Guides offnen',
    homeTopicMarketTitle: 'Marktupdates',
    homeTopicMarketText: 'Neue Fahrzeugstarts, Preisbewegungen und Branchentrends, die deine nachste Entscheidung beeinflussen konnen.',
    homeTopicMarketLink: 'News lesen',
    homeTopicOwnershipTitle: 'Besitzkosten',
    homeTopicOwnershipText: 'Kraftstoff, Laden, Wertverlust und laufende Kosten fur Alltagsautos und Performance-Modelle.',
    homeTopicOwnershipLink: 'Artikel ansehen',
    homeTopicPerformanceTitle: 'Leistungsdaten',
    homeTopicPerformanceText: 'PS, Beschleunigung und Hochstgeschwindigkeit fur den direkten Vergleich geordnet.',
    homeTopicPerformanceLink: 'Autos vergleichen',
    homeTopicMethodologyTitle: 'Datenmethodik',
    homeTopicMethodologyText: 'Wie CarQuantix Spezifikationen, Schatzungen und Modelljahresunterschiede behandelt.',
    homeTopicMethodologyLink: 'Notizen ansehen',
    homeTopicMarketplaceTitle: 'Marktplatz-Angebote',
    homeTopicMarketplaceText: 'Durchsuche offentliche Angebote oder veroffentliche ein strukturiertes Inserat mit Preis, Kilometerstand und Verkauferdaten.',
    homeTopicMarketplaceLink: 'Marktplatz besuchen',
    homeArticlesTitle: 'Neueste CarQuantix Artikel',
    homeArticlesLead: 'Frische Analysen fur alle, die Leistung, Kosten und Besitz vor der Entscheidung vergleichen.',
    homeArticlesAll: 'Alle Artikel ansehen',
    homeArticleEvTopic: 'Elektro-Besitz',
    homeArticleEvTitle: 'EV-Betriebskosten: was vor der Monatsrechnung zu vergleichen ist',
    homeArticleEvText: 'Blicke uber Reichweite hinaus und vergleiche Ladepreis, Effizienz, Pendelstrecke und saisonale Verluste.',
    homeArticleEvRead: '8 Min. Lesezeit',
    homeArticlePerformanceTopic: 'Leistungsdaten',
    homeArticlePerformanceTitle: 'PS, Beschleunigung und warum Zahlen nicht immer zusammenpassen',
    homeArticlePerformanceText: 'Wie Ubersetzung, Traktion und Gewicht verandern konnen, was ein Datenblatt verspricht.',
    homeArticlePerformanceRead: '6 Min. Lesezeit',
    homeArticleBuyingTopic: 'Kaufguide',
    homeArticleBuyingTitle: 'Die schnelle Besitz-Checkliste vor der Gebrauchtwagen-Shortlist',
    homeArticleBuyingText: 'Preis ist nur ein Signal. Erganzte Kilometerstand, Kraftstoff, Wertverlust und Verkauferklarheit vor der Entscheidung.',
    homeArticleBuyingRead: '7 Min. Lesezeit',
  },
  fr: {
    homeHeroKicker: 'Decisions auto plus intelligentes',
    ...
    homeTopicBuyerTitle: 'Listes d acheteurs',
    homeTopicBuyerText: 'Comparaisons de modeles, bons choix de valeur et controles pratiques avant de vous engager.',
    homeTopicBuyerLink: 'Ouvrir les guides',
    homeTopicMarketTitle: 'Actualites du marche',
    homeTopicMarketText: 'Nouveaux lancements, mouvements de prix et changements du secteur pouvant influencer votre prochaine decision.',
    homeTopicMarketLink: 'Lire les actualites',
    homeTopicOwnershipTitle: 'Couts de possession',
    homeTopicOwnershipText: 'Carburant, recharge, depreciation et couts d utilisation pour voitures quotidiennes et performantes.',
    homeTopicOwnershipLink: 'Voir les articles',
    homeTopicPerformanceTitle: 'Donnees de performance',
    homeTopicPerformanceText: 'Puissance, acceleration et vitesse maximale organisees pour une comparaison cote a cote.',
    homeTopicPerformanceLink: 'Comparer les voitures',
    homeTopicMethodologyTitle: 'Methodologie des donnees',
    homeTopicMethodologyText: 'Comment CarQuantix traite specifications, estimations et differences de millesime.',
    homeTopicMethodologyLink: 'Voir les notes',
    homeTopicMarketplaceTitle: 'Annonces marketplace',
    homeTopicMarketplaceText: 'Consultez les offres publiques ou publiez une annonce structuree avec prix, kilometrage et vendeur.',
    homeTopicMarketplaceLink: 'Visiter la marketplace',
    homeArticlesTitle: 'Dernieres lectures CarQuantix',
    homeArticlesLead: 'Analyses recentes pour comparer performance, couts et possession avant de choisir.',
    homeArticlesAll: 'Voir tous les articles',
    homeArticleEvTopic: 'Possession electrique',
    homeArticleEvTitle: 'Couts d utilisation EV : quoi comparer avant la facture mensuelle',
    homeArticleEvText: 'Allez au-dela de l autonomie et comparez prix de recharge, efficacite, trajet quotidien et pertes saisonnieres.',
    homeArticleEvRead: '8 min de lecture',
    homeArticlePerformanceTopic: 'Donnees de performance',
    homeArticlePerformanceTitle: 'Puissance, acceleration et pourquoi les chiffres ne concordent pas toujours',
    homeArticlePerformanceText: 'Comment rapports, motricite et poids peuvent changer ce qu une fiche technique promet.',
    homeArticlePerformanceRead: '6 min de lecture',
    homeArticleBuyingTopic: 'Guide d achat',
    homeArticleBuyingTitle: 'La checklist rapide avant de retenir une voiture d occasion',
    homeArticleBuyingText: 'Le prix n est qu un signal. Ajoutez kilometrage, carburant, depreciation et clarte du vendeur avant de decider.',
    homeArticleBuyingRead: '7 min de lecture',
  },
  es: {
    homeHeroKicker: 'Decisiones de vehiculo mas inteligentes',
    ...
    homeTopicBuyerTitle: 'Listas de compradores',
    homeTopicBuyerText: 'Comparaciones de modelos, opciones de valor y revisiones practicas antes de elegir un auto.',
    homeTopicBuyerLink: 'Abrir guias',
    homeTopicMarketTitle: 'Actualizaciones del mercado',
    homeTopicMarketText: 'Lanzamientos, cambios de precio y movimientos de la industria que pueden afectar tu proxima decision.',
    homeTopicMarketLink: 'Leer noticias',
    homeTopicOwnershipTitle: 'Costos de propiedad',
    homeTopicOwnershipText: 'Combustible, carga, depreciacion y costos de uso para autos diarios y de rendimiento.',
    homeTopicOwnershipLink: 'Ver articulos',
    homeTopicPerformanceTitle: 'Datos de rendimiento',
    homeTopicPerformanceText: 'Potencia, aceleracion y velocidad maxima organizadas para comparar lado a lado.',
    homeTopicPerformanceLink: 'Comparar autos',
    homeTopicMethodologyTitle: 'Metodologia de datos',
    homeTopicMethodologyText: 'Como CarQuantix trata especificaciones, estimaciones y diferencias de ano modelo.',
    homeTopicMethodologyLink: 'Ver notas',
    homeTopicMarketplaceTitle: 'Anuncios del mercado',
    homeTopicMarketplaceText: 'Explora ofertas publicas o publica un anuncio estructurado con precio, kilometraje y datos del vendedor.',
    homeTopicMarketplaceLink: 'Visitar mercado',
    homeArticlesTitle: 'Lecturas recientes de CarQuantix',
    homeArticlesLead: 'Analisis nuevos para comparar rendimiento, costo y propiedad antes de elegir.',
    homeArticlesAll: 'Ver todos los articulos',
    homeArticleEvTopic: 'Propiedad electrica',
    homeArticleEvTitle: 'Costos de uso EV: que comparar antes de que llegue la factura mensual',
    homeArticleEvText: 'Mira mas alla de la autonomia y compara precio de carga, eficiencia, distancia diaria y perdidas estacionales.',
    homeArticleEvRead: '8 min de lectura',
    homeArticlePerformanceTopic: 'Datos de rendimiento',
    homeArticlePerformanceTitle: 'Potencia, aceleracion y por que los numeros no siempre coinciden',
    homeArticlePerformanceText: 'Como cambios, traccion y peso pueden alterar lo que promete una ficha tecnica.',
    homeArticlePerformanceRead: '6 min de lectura',
    homeArticleBuyingTopic: 'Guia de compra',
    homeArticleBuyingTitle: 'La lista rapida antes de preseleccionar un auto usado',
    homeArticleBuyingText: 'El precio es solo una senal. Agrega kilometraje, combustible, depreciacion y claridad del vendedor antes de decidir.',
    homeArticleBuyingRead: '7 min de lectura',
  },
  ru: {
    homeHeroKicker: 'Умный выбор автомобиля',
    homeHeroTitlePrefix: 'Сравнивайте автомобили по',
    homeHeroTitleAccent: 'важным показателям',
    homeHeroTitleSuffix: '.',
    homeHeroLead: 'Сопоставьте характеристики, расходы, данные о владении и рыночную информацию перед принятием решения.',
    homeHeroCompare: 'Сравнить автомобили',
    homeHeroSell: 'Продать автомобиль',
    homeTopicsKicker: 'Направления исследований',
    homeTopicsTitle: 'Изучите данные для более обоснованного выбора автомобиля.',
    homeTopicsLead: 'Переходите от быстрого сравнения к практическим руководствам, новостям рынка и анализу расходов на владение.',
    homeTopicBuyerTitle: 'Подборки для покупателей',
    homeTopicBuyerText: 'Сравнение моделей, выгодные варианты и практические проверки перед покупкой.',
    homeTopicBuyerLink: 'Открыть руководства',
    homeTopicMarketTitle: 'Новости рынка',
    homeTopicMarketText: 'Новые модели, изменения цен и события отрасли, которые могут повлиять на ваш выбор.',
    homeTopicMarketLink: 'Читать новости',
    homeTopicOwnershipTitle: 'Расходы на владение',
    homeTopicOwnershipText: 'Топливо, зарядка, потеря стоимости и эксплуатационные расходы повседневных и спортивных автомобилей.',
    homeTopicOwnershipLink: 'Смотреть статьи',
    homeTopicPerformanceTitle: 'Данные о динамике',
    homeTopicPerformanceText: 'Мощность, разгон и максимальная скорость для удобного сравнения.',
    homeTopicPerformanceLink: 'Сравнить автомобили',
    homeTopicMethodologyTitle: 'Методология данных',
    homeTopicMethodologyText: 'Как CarQuantix работает с характеристиками, оценками и различиями модельных годов.',
    homeTopicMethodologyLink: 'Открыть пояснения',
    homeTopicMarketplaceTitle: 'Объявления о продаже',
    homeTopicMarketplaceText: 'Просматривайте предложения или публикуйте объявление с ценой, пробегом и данными продавца.',
    homeTopicMarketplaceLink: 'Перейти на рынок',
    homeArticlesTitle: 'Новые материалы CarQuantix',
    homeArticlesLead: 'Свежий анализ характеристик, расходов и особенностей владения для осознанного выбора.',
    homeArticlesAll: 'Посмотреть все статьи',
    homeArticleEvTopic: 'Владение электромобилем',
    homeArticleEvTitle: 'Расходы на электромобиль: что сравнить до получения ежемесячного счёта',
    homeArticleEvText: 'Учитывайте не только запас хода, но и стоимость зарядки, эффективность, ежедневный пробег и сезонные потери.',
    homeArticleEvRead: '8 мин чтения',
    homeArticlePerformanceTopic: 'Динамические характеристики',
    homeArticlePerformanceTitle: 'Мощность, разгон и причины расхождения показателей',
    homeArticlePerformanceText: 'Как передаточные числа, сцепление и масса меняют результаты, обещанные характеристиками.',
    homeArticlePerformanceRead: '6 мин чтения',
    homeArticleBuyingTopic: 'Руководство покупателя',
    homeArticleBuyingTitle: 'Краткая проверка подержанного автомобиля перед добавлением в список',
    homeArticleBuyingText: 'Цена — лишь один показатель. Учитывайте пробег, топливо, потерю стоимости и прозрачность продавца.',
    homeArticleBuyingRead: '7 мин чтения',
    homeArticleDate: '3 июля 2026 г.',
  },
};

Object.keys(HOME_TRANSLATIONS).forEach((code) => {
  if (TRANSLATIONS[code]) {
    Object.assign(TRANSLATIONS[code], HOME_TRANSLATIONS[code]);
  }
});
...
Object.assign(TRANSLATIONS.ru, HOME_TRANSLATIONS.ru);
...
const FOOTER_TRANSLATIONS = {
  ...
  ru: {
    navAuthor: 'Author',
    navHome: 'Главная',
    navSellCar: 'Продать автомобиль',
    navMethodology: 'Методология',
    footerCorporate: 'Платформа',
    footerExplore: 'Ресурсы',
    footerInfo: 'Компания и правовая информация',
  },
};
...
const SEO_PRESELECT = {
  ...
  'ferrari-enzo-vs-lamborghini-countach': { catalog: 'cars', ids: ['Enzo Ferrari', 'Countach'] },
  'ferrari-enzo-ferrari-vs-lamborghini-countach': { catalog: 'cars', ids: ['Enzo Ferrari', 'Countach'] },
  'ferrari-enzo-vs-lamborghini-aventador': { catalog: 'cars', ids: ['Enzo Ferrari', 'Aventador'] },
  'ferrari-enzo-vs-lamborghini-revuelto': { catalog: 'cars', ids: ['Enzo Ferrari', 'Revuelto'] },
  'ferrari-laferrari-vs-lamborghini-revuelto': { catalog: 'cars', ids: ['LaFerrari', 'Revuelto'] },
  'ferrari-f40-vs-lamborghini-countach': { catalog: 'cars', ids: ['F40', 'Countach 2'] },
  'ferrari-f50-vs-lamborghini-diablo': { catalog: 'cars', ids: ['F50', 'Diablo'] },
